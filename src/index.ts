...
process.env.CHATPICKLE_CONSUMER_PATH_ABSOLUTE = process.env.CHATPICKLE_CONSUMER_PATH ? 
    `${process.cwd()}/${process.env.CHATPICKLE_CONSUMER_PATH}` : process.cwd();

const runArgs = [null, '', `${process.env.CHATPICKLE_CONSUMER_PATH || ''}chatpickle`, '--require', 'dist/cucumberSupport'];
