Feature: ScheduleAppointment Bot
    ...
    Scenario: Happy Path - Anonymous sets up cleaning appointment
        Given the user begins a new chat with "ScheduleAppointment_bot"
        When they say:
        ...
        * User: tomorrow
        * BotRegex: At what time
        * User: four pm
        * BotRegex: \d{2}:\d{2} is available, should I go ahead and book your appointment?
        * User: yes